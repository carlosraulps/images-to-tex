...
A modular Python application that transforms handwritten notes (PDFs or Images) into editable, semantic LaTeX code using the **Google Gemini 3.0 Pro Preview** API.
